...
```csharp
Configuration.Authorization.Providers.Add<CustomerDetailAuthorizationProvider>();
...
{
   modelBuilder.ApplyConfiguration(new CustomerDetailCfg());
 }
...
```
Add-Migration AddNewCustomerDetailEntity_Migration
```
