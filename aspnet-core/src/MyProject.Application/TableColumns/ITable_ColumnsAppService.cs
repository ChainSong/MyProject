...
namespace MyProject.TableColumns
{
    ...
    /// 应用层服务的接口方法
    ///</summary>
    public interface ITable_ColumnsAppService : IApplicationService
    {
        /// <summary>
		/// 获取的分页列表集合
		///</summary>
        ...
        /// <param name="input"></param>
        /// <returns></returns>
        Task<GetTable_ColumnsForEditOutput> GetForEdit(NullableIdDto<long> input);
        ...
        /// <param name="input"></param>
        /// <returns></returns>
        Task CreateOrUpdate(CreateOrUpdateTable_ColumnsInput input);
