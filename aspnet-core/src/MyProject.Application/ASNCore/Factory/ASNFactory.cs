...
namespace MyProject.ASNCore.Factory
{
    ...
    {
        public static IASNInterface CreateASN(IRepository<WMS_ASN, long> wms_asnRepository,
            ...
            ICustomerUserMappingManager customerusermappingManager,long CustomerId)
        {
            ...
            switch (CustomerId)
            {
                case (long)ASNExcelEnum.ASNExportDefault:
                    return new ASNDefaultStrategy(wms_asnRepository, wms_asndetailRepository, warehouseusermappingManager, customerusermappingManager);
                default:
                    return new ASNDefaultStrategy(wms_asnRepository, wms_asndetailRepository, warehouseusermappingManager, customerusermappingManager);
            }
