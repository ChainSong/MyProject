...
namespace MyProject.WarehouseCore
{
	public interface IWarehouseUserMappingAppService : IApplicationService
	{
        ...
        /// <returns></returns>
        Task<PagedResultDto<WarehouseUserMappingListDto>> GetPaged(GetWarehouseUserMappingsInput input);
        ...
        /// <param name="input"></param>
        /// <returns></returns>
        Task CreateOrUpdate(CreateOrUpdateWarehouseUserMappingInput input);
