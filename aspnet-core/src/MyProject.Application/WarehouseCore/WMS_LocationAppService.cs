		...
		public async Task<PagedResultDto<WMS_LocationListDto>> GetPaged(GetWMS_LocationsInput input)
		{
			var query = _wms_locationRepository.GetAll()
                          ...
                          .WhereIf(!input.FilterText.IsNullOrWhiteSpace(), a => a.WarehouseName.Contains(input.FilterText))                                                                                      
                            //模糊搜索 字段AreaId
                          .WhereIf(!input.FilterText.IsNullOrWhiteSpace(), a => a.AreaId.Contains(input.FilterText))                                                                                      
                            //模糊搜索 字段AreaName
                          ...
                          .WhereIf(!input.FilterText.IsNullOrWhiteSpace(), a => a.Location.Contains(input.FilterText))                                                                                      
                            //模糊搜索 字段LocationType
                          .WhereIf(!input.FilterText.IsNullOrWhiteSpace(), a => a.LocationType.Contains(input.FilterText))                                                                                      
                            //模糊搜索 字段ABCClassification
                          .WhereIf(!input.FilterText.IsNullOrWhiteSpace(), a => a.ABCClassification.Contains(input.FilterText))                                                                                      
                            //模糊搜索 字段LocationLevel
                          .WhereIf(!input.FilterText.IsNullOrWhiteSpace(), a => a.LocationLevel.Contains(input.FilterText))                                                                                      
                            //模糊搜索 字段GoodsPutOrder
                          .WhereIf(!input.FilterText.IsNullOrWhiteSpace(), a => a.GoodsPutOrder.Contains(input.FilterText))                                                                                      
                            //模糊搜索 字段GoodsPickOrder
                          .WhereIf(!input.FilterText.IsNullOrWhiteSpace(), a => a.GoodsPickOrder.Contains(input.FilterText))                                                                                      
                            //模糊搜索 字段SKU
