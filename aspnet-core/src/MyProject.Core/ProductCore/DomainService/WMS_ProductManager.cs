...
namespace MyProject.ProductCore.DomainService
{
    ...
    /// 领域服务层一个模块的核心业务逻辑
    ///</summary>
    public class WMS_ProductManager :MyProjectDomainServiceBase, IWMS_ProductManager
    {
	...
	public WMS_ProductManager(IRepository<WMS_Product, long> wMS_ProductRepository)	{
        ...
        /// </summary>
        /// <returns></returns>
        public IQueryable<WMS_Product> QueryWMS_Products()
        {
        ...
        /// </summary>
        /// <returns></returns>
        public IQueryable<WMS_Product> QueryWMS_ProductsAsNoTracking()
        {
