...
namespace MyProject.TableColumns.DomainService
{
    public interface ITable_ColumnsManager : IDomainService//I52AbpDomainService<Table_Columns, long>
    {
		...
		IQueryable<Table_Columns> QueryEntityListAsNoTracking();
        /// <summary>
        /// 返回表达式数的实体信息即IQueryable类型
        /// </summary>
        /// <returns>IQueryable</returns>
        IQueryable<Table_Columns> Query();
        /// <summary>
        /// 返回性能更好的IQueryable类型，但不包含EF Core跟踪标记
        /// </summary>
        /// <returns>IQueryable</returns>
        IQueryable<Table_Columns> QueryAsNoTracking();
        ...
        /// <returns></returns>
        Task<Table_Columns> CreateAsync(Table_Columns entity);
        ...
        /// <param name="entity">实体</param>
        /// <returns></returns>
        Task UpdateAsync(Table_Columns entity);
