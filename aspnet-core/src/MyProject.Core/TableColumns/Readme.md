...
```csharp
Configuration.Authorization.Providers.Add<Table_ColumnsAuthorizationProvider>();
...
```csharp
public DbSet<Table_Columns>  Table_Columnss { get; set; }
...
{
   modelBuilder.ApplyConfiguration(new Table_ColumnsCfg());
 }
...
```
Add-Migration AddNewTable_ColumnsEntity_Migration
```
