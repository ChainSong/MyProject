...
namespace MyProject.ReceiptReceivingCore.DomainService
{
    ...
    /// 领域服务层一个模块的核心业务逻辑
    ///</summary>
    public class WMS_ReceiptReceivingManager :DomainServiceBase, IWMS_ReceiptReceivingManager
    {
		
		private readonly IRepository<WMS_ReceiptReceiving,long> _wms_receiptreceivingRepository;

		/// <summary>
		/// 【WMS_ReceiptReceiving】的构造方法
		/// 通过构造函数注册服务到依赖注入容器中
		///</summary>
        ...
        /// </summary>
        /// <returns></returns>
        public IQueryable<WMS_ReceiptReceiving> QueryEntityListAsNoTracking() { 

            var query = _wms_receiptreceivingRepository.GetAll().AsNoTracking()
                        .Select(x => new WMS_ReceiptReceiving
                        {
                            ...
                            ReceiptReceivingStatus = x.ReceiptReceivingStatus,
        ...
        /// <summary>
        /// 【WMS_ReceiptReceiving】返回表达式数的实体信息即IQueryable类型
        /// </summary>
        /// <returns>IQueryable</returns>
        public IQueryable<WMS_ReceiptReceiving> Query()
        {
            return _wms_receiptreceivingRepository.GetAll();
        }
        /// <summary>
        /// 【WMS_ReceiptReceiving】返回即IQueryable类型的实体，不包含EF Core跟踪标记
        /// </summary>
        /// <returns>IQueryable</returns>
        public IQueryable<WMS_ReceiptReceiving> QueryAsNoTracking()
        {
            return _wms_receiptreceivingRepository.GetAll().AsNoTracking();
        }
        /// <summary>
        /// 【WMS_ReceiptReceiving】根据Id查询实体信息
        /// </summary>
        /// <param name="id"></param>
        /// <returns>实体</returns>
        public async Task<WMS_ReceiptReceiving> FindByIdAsync(long id)
        {
            var entity = await _wms_receiptreceivingRepository.GetAsync(id);
            return entity;
        }
        /// <summary>
        /// 【WMS_ReceiptReceiving】检查实体是否存在
        /// </summary>
        /// <param name="id"></param>
