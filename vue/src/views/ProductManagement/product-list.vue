          ...
          <Row>
            ...
            <FormItem :label="i.displayName" v-if="i.isSearchCondition" style="width:95%">
              <template v-if="i.type == 'TextBox'">
                <el-input placeholder="请输入内容" v-model="product[i.columnName]" v-if="i.isSearchCondition">
                </el-input>
              </template>
              <template v-if="i.type == 'DropDownListInt'">
                <el-select v-model="product[i.columnName]" v-if="i.isSearchCondition" placeholder="请选择">
        ...
        <el-table :data="list" style="width: 100%" max-height="300">
          <template v-for="v in tableColumns">
            <template v-if="v.isShowInList">
              <el-table-column v-if="v.type == 'DropDownListInt'" v-bind:key="v.id" :fixed="false"
