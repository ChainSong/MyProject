<template>
  <div>
    <Modal title="库区详情" :value="value" width="50" @on-visible-change="visibleChange">
...
// import Detail from "../../store/entities/areaDetail";
import TableColumns from "@/store/entities/tableColumns";
@Component
export default class AreaQuery extends AbpBase {
  ...
  visibleChange(value: boolean) {
    if (!value) {
      ...
      this.header = Util.extend(
        true,
        {},
        this.$store.state.area.queryArea
      );
      this.get();
    }
  }
