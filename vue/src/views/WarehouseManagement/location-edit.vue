<template>
  <div>
    <Modal title="编辑库位" :value="value" width="50" @on-visible-change="visibleChange">
...
export default class locationEdit extends AbpBase {
  ...
  visibleChange(value: boolean) {
    if (!value) {
      ...
      this.header = Util.extend(
        true,
        {},
        this.$store.state.location.editLocation
      );
      this.get();
    }
  }
