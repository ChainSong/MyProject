<template>
  <div>
    <Modal title="预出库单详情" :value="value" width="60" @on-visible-change="visibleChange">
      <!-- <el-container>
        <el-main> -->
...
import { getformatTime } from "@/utils/formatDateTime";
@Component
export default class PreOrderQuery extends AbpBase {
  ...
  get() {
    this.$store
      ...
      .then((res) => {
        ...
        this.detailDatas.details = res.preOrderDetails;
  ...
  visibleChange(value: boolean) {
    if (!value) {
      ...
      this.header = Util.extend(
        true,
        {},
        this.$store.state.preorder.queryPreOrder
      );
      // console.log(this.header);
      this.get();
    }
