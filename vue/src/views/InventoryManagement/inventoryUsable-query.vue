<template>
  <div>
    <Modal title="库存详情" :value="value" width="50" @on-visible-change="visibleChange">
...
import Header from "../../store/entities/inventoryUsable";
// import Detail from "../../store/entities/inventoryUsableDetail";
import TableColumns from "@/store/entities/tableColumns";
@Component
export default class InventoryUsableQuery extends AbpBase {
  ...
  gettableColumn() {
    this.tableColumnHeader.tableName = "WMS_Inventory_Usable";
  ...
  visibleChange(value: boolean) {
    ...
    if (!value) {
      ...
      this.header = Util.extend(
        true,
        {},
        this.$store.state.inventoryUsable.queryInventoryUsable
