...
<template>
  <div class="main" :class="{ 'main-hide-text': shrink }">
    <div class="sidebar-menu-con" :style="{ width: shrink ? '80px' : '216px', overflow: shrink ? 'visible' : 'auto' }">
    ...
    <div class="main-header-con" :style="{ paddingLeft: shrink ? '80px' : '130px' }" style="height:50px">
      <div class="main-header" style="height:50px">
        ...
        <div class="header-middle-con" style="padding-bottom:0">
          <div class="tags-con">
    ...
    <div class="single-page-con" :style="{ left: shrink ? '80px' : '206px' }" style="top:45px">
